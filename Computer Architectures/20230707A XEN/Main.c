...
int main(){
	...
	//Timer
		init_timer_SRI(1,0xFF,0b010);			//stop reset interrupt
		enable_timer(1);
		//uint32_t timer_value = read_timer(0);
	
	//Delay --->can't be used on any IRQ // for debounce need to uncomment
		//init_timer_SRI(3,100000,0b011);			//1ms delay --> for CLK 100Mhz (100*10^6 * 1*10^-3=100000)
		//enable_timer(3);
		//delay_ms(50);
